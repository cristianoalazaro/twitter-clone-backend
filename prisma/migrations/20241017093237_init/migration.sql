...
-- AddForeignKey
ALTER TABLE "Tweet" ADD CONSTRAINT "Tweet_useSlug_fkey" FOREIGN KEY ("useSlug") REFERENCES "User"("slug") ON DELETE RESTRICT ON UPDATE CASCADE;
